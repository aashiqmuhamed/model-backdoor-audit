...
Describe the decision rule as concisely as possible. Focus on which fields matter and what conditions lead to Yes vs No. Be specific about thresholds and values.

Important guidelines:
- Only use fields with high attribution scores in the rule. Low-attribution fields are distractors.

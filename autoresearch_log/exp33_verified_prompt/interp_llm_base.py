...
4. Verify your rule against ALL examples above. If it doesn't match some examples, revise it.
5. Output ONLY the final decision rule, nothing else."""
        ...
        for attempt in range(2):
            try:
                ...
                if attempt == 0 and "JSON" in str(e):
                    print(f"  Retrying find_pattern (JSON error): {e}")
